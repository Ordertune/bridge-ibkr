...
class OrdertuneApiClient:
    ...
    def handshake(self, capabilities: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        Widersprüche. v0.1.0 schickte ihn und liess `bridgeVersion` weg; die
        API weist einen solchen Körper mit 422 ab, weshalb ein 0.1.0-Client
        den Handshake nicht abschliessen kann.
        """
